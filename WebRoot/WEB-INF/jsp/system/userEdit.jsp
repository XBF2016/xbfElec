			...
			<table cellSpacing="1" cellPadding="5" width="620px" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input id='account' name="account" type="text"  value="<s:property value="%{account}"/>" readonly="readonly"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">用户姓名：<font color="#FF0000">*</font></td>
					<td class="ta_01" bgColor="#ffffff">
						<input id="username" name="username" type="text"  value="<s:property value="%{username}"/>" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="password" type="password"  value="<s:property value="%{password}"/>"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">确认密码：</td>
					<td class="ta_01" bgColor="#ffffff">
						<input name="repassword" type="password"  value="<s:property value="%{password}"/>"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="birthday" type="text"  value="<s:property value="%{birthday}"/>" onclick="WdatePicker()" />
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">联系地址：</td>
					<td class="ta_01" bgColor="#ffffff">
						<input name="address" type="text"  value="<s:property value="%{address}"/>" />
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="homeTel" type="text"  value="<s:property value="%{homeTel}"/>"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机：</td>
					<td class="ta_01" bgColor="#ffffff">
						<input name="mobile" type="text"  value="<s:property value="%{phone}"/>"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="email" type="text"  value="<s:property value="%{email}"/>" />
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">是否在职：</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:radio name="isDuty"  list="%{#application.dict.dictMap.isDuty}"></s:radio>
						<!-- 
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="onDutyDate" type="text"  value="<s:property value="%{onDutyDate}"/>" onclick="WdatePicker()">
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<textarea name="comment" style="WIDTH: 95%" rows="4" cols="52"><s:property value="%{comment}"/></textarea>
					</td>
				</tr>
				<tr>
